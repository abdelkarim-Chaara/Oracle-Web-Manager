...
<h3 style="font-family: OCR A Std, monospace ; text-align: center; font-size: 50px">EXPORT TABLESPACES</h3>
...
$cmd= "expdp test/test@orcl tablespaces=$tables directory=dpdir  dumpfile=$tables.tblspace logfile=exp.log";
system($cmd,$return);
if($return === 0) {


header("location:$tables.tblspace ");
