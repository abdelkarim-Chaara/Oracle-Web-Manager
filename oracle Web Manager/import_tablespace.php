...
<html>
<head>
	<title>Import TableSpaces </title>
...
<h3 style="font-family: OCR A Std, monospace ; text-align: center; font-size: 50px"> IMPORT TABLESPACES </h3>
<form action="" method="POST" enctype="multipart/form-data">

	
<div class="container" style="margin-top:20%;width:50%;height:50%;">

<label style="margin-right:5px">TableSpace Name : </label><input width="100%" class="form-control"  type="text" name="tables"/></br></br>
...
$cmd= "impdp system/tr@orcl tablespaces=$table  directory=dpdir dumpfile=$filename logfile=exp.log";
system($cmd,$return);
