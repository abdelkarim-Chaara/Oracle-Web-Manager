...
<h3 style="font-family: OCR A Std, monospace ; text-align: center; font-size: 50px">SAVE SCHEMAS TO CLOUD</h3>
...
if ($handle = opendir('.')) {
    ...
    {
        if ($file != "." && $file != ".." && strtolower(substr($file, strrpos($file, '.') + 1)) == 'sch')
        { 
$i=1;
